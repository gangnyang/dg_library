...
CREATE TABLE `external_books` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `isbn` (`isbn`),
  CONSTRAINT `external_books_ibfk_1` FOREIGN KEY (`id`) REFERENCES `books` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'test1','test1','$2b$12$tFqotN3iXYhIkrwCvnYcJ.lPksPfH3rP9IVzobO6zU/RbHaT80rfW',NULL,'user','2024-11-24 15:59:32');
...
-- Dump completed on 2024-11-25  1:57:49
